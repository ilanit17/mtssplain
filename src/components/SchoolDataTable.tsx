                            ...
                            >
                                ...
                                <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-900">
                                    <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                                        school.overallAverage >= 3.2 ? 'bg-green-100 text-green-800' :
                                        school.overallAverage > 2.2 ? 'bg-yellow-100 text-yellow-800' :
                                ...
                                <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500">
                                    <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium border ${getTierColor(school.mtssTier)}`}>
                                        Tier {school.mtssTier}
                                    </span>
                                </td>
                                <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500">
                                    <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium border ${getRiskColor(school.riskLevel)}`}>
                                        {school.riskLevel}
                                    </span>
                                </td>
                            </tr>
